var heart_button_html = "<img class=\"heartbutton\" title=\"Favorite\" width=\"32px\" height=\"32px\" src=\"./assets/heart_unfilled.png\" "
+"onmouseover=\"this.src='./assets/heart_unfilled_shadow.png'\" "
+"onmouseout=\"this.src='./assets/heart_unfilled.png'\">";

var heart_button_filled_html = "<img class=\"heartbutton\" title=\"Favorite\" width=\"32px\" height=\"32px\" src=\"./assets/heart_filled.png\" "
...
var placeControlPanel = function() {
    ...
    $('.gearbutton:first').click(function() {
...
var placeMiniSearchBar = function() {
	...
	$("#searchfield").select2({tags: ['opening', 'endgame', 'midgame' , 'beginner',  'intermediate', 'expert', 'offense','defense','strategy', 'tactic','positional' , 'book', 'video','lol', 'caro-kann','scotch','sicilian'],
		multiple: true, width: '60%', openOnEnter: false});
